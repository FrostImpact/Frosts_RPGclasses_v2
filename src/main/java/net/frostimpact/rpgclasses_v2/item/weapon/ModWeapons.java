...
import net.frostimpact.rpgclasses_v2.item.weapon.sword.ClaymoreItem;
import net.frostimpact.rpgclasses_v2.item.weapon.sword.LongswordItem;
import net.frostimpact.rpgclasses_v2.item.weapon.sword.ShortswordItem;
