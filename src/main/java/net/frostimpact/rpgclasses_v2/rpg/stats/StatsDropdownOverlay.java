...
public class StatsDropdownOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        // Border
        guiGraphics.fill(panelX, panelY, 
                       panelX + PANEL_WIDTH, panelY + 1, 0xFFAAAAAA); // Top
        guiGraphics.fill(panelX, panelY, 
                       panelX + 1, panelY + contentHeight, 0xFFAAAAAA); // Left
        guiGraphics.fill(panelX + PANEL_WIDTH - 1, panelY, 
                       panelX + PANEL_WIDTH, panelY + contentHeight, 0xFF555555); // Right
        guiGraphics.fill(panelX, panelY + contentHeight - 1, 
                       panelX + PANEL_WIDTH, panelY + contentHeight, 0xFF555555); // Bottom
        
        // Draw stats
        int textStartX = panelX + 5;
